...
const IconWrapper = styled.div`
  font-size: 2rem;
`
.sc-bqOBKd ilvVqi"><an></h3><r jvcaOx"><span class="sc-fnOeiS HQHiM">★</span><span class="sc-fnOeiS HQHiM">★</span><span class="sc-fnOeiS HQHiM">★</span><span class="sc-fnOeiS hIPOtD">★</span><span class="sc-fnOeiS hIPOtD">★</span></div></div>
